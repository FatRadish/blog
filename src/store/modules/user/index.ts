...
export const uesUserStore = defineStore('user',{
  ...
  getters:{
    ...
    avatar(): string {
      return this.userInfo.avatar || 'http://fat-radish-blog.oss-cn-hangzhou.aliyuncs.com/config/ba67e789e75b79bc22728f00e4761e59.jpg' // 默认头像
    },
    website(): string {
    ...
    async getUserInfo(){
      ...
      try{
        ...
        if(res.code === 0 ){
          ...
          console.log(article_like_set,comment_like_set)
          this.userInfo = {
            id,
            nickname,
            avatar,
